...
contract QwoynExchange is Exchange {

    string public constant name = "Qwoyn Collectibles Exchange";

    string public constant version = "1.0";

    string public constant codename = "ETC Exchange";
